...
public class ColorPicker {
	...
	static {
		cards2.add(Card.TWO_CLUBS);
		cards2.add(Card.FOUR_CLUBS);
		cards2.add(Card.FIVE_CLUBS);
		cards2.add(Card.SIX_CLUBS);
		cards2.add(Card.SEVEN_CLUBS);
		cards2.add(Card.EIGHT_CLUBS);
		cards2.add(Card.NINE_CLUBS);
	}

	static final SimpleRange range = SimpleRange.full();

	public static boolean test1(List<ElementRange> hands,
			List<Card> commCards) {
