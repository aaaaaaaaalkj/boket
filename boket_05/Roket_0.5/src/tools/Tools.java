...
public final class Tools {
  ...
  @SuppressWarnings("null")
  public static Double procent(final double d) {
    return (double) Math.round(d * ROUND_TO_DIGITS);
  }
  ...
  /**
   * Since Math.max() seems to be very slow, we can use this max-function
   * 
   * @param x
   * @param y
   * @return max(x,y)
  ...
  @SuppressWarnings("null")
  public static Double minBoxed(double a, double b) {
    return Math.min(a, b);
  }

  public static void checkArg(double argument, int min, int max) {
