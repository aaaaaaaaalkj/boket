...
public class LateRoundHand {
  ...
  public static void simulation(final int numPlayers, final List<LateRoundHand> hands,
  ...
  public static void main(final String[] args) {
    ...
    CommunityCardsX flop = new CommunityCardsX(Tools.asList(Card.AD, Card.S3, Card.C7));
