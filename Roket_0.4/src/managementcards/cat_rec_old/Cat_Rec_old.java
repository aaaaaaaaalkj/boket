...
public final class Cat_Rec_old {
  ...
  public static Result_old getResult(final Set<Card> set) {
  ...
  public static @Nullable Result_old checkFlush(final Set<Card> set) {
  ...
  public static @Nullable Result_old checkStraight(final Set<Card> set) {
    int counter = 0;
    int high = -1;
  ...
  public static @Nullable Result_old checkStraightFlush(final Set<Card> set) {
    int counter = 0;
    int high = -1;
    for (Suit color : Suit.values()) {
      for (int i = NUM - 1; i > -2; i--) {
  ...
  private static Result_old checkPairBased(final Set<Card> set) {
  ...
  private static @Nullable int[] toIntArr(final ArrayList<Integer> list) {
