...
public enum GroupedRange implements Range {
	...
	private GroupedRange(Rank r1, Rank r2, boolean suited) {
		this.r1 = r1;
		this.r2 = r2;
		this.suited = suited;
	}
	...
	private static class Finder {
		...
		public Finder(Rank r1, Rank r2, boolean suited) {
			this.r1 = r1;
			this.r2 = r2;
			this.suited = suited;
		}
	...
	public static GroupedRange find(Rank r1, Rank r2, boolean suited) {
	...
	public static void ungroup2(SimpleRange ranges, Rank r1, Rank r2,
			boolean suited) {
	...
	public boolean contains(ElementRange r) {
		if ((r1 == r.r1 && r2 == r.r2) || (r1 == r.r2 && r2 == r.r1)) {
