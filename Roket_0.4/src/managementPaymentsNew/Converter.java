...
public class Converter {
	...
	public Converter(int player, IPayManagement2 pay) {
		this.player = player;
	...
	public Decision convert(TypeOfDecision d) {
		int value = 0;
		...
		return try_bet_raise(value);
	}

	private Decision try_call(AllowedDecision a) {
	...
	private Decision try_bet_raise(int value) {
		if (a.isRaiseAllowed()) {
			if (value < toCall / 2) {
